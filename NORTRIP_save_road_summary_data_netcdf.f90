...
subroutine NORTRIP_create_summary_netcdf(filename,ncid)
    ...
    call check(nf90_def_dim(ncid,"maxdatelength", 24 , date_dimid))
    ...
    call check(nf90_def_var(ncid, "T_surf_mod", nf90_double, (/t_dimid,f_dimid/),varid))
    ...
    call check(nf90_def_var(ncid, "T_surf_meteo", nf90_double, (/t_dimid,f_dimid/),varid))
    call check(nf90_put_att(ncid,varid, "units", "Celsius"))
    ...
    call check(nf90_def_var(ncid, "T_air", nf90_double, (/t_dimid,f_dimid/),varid))
    call check(nf90_put_att(ncid,varid, "units", "Celsius"))
    call check(nf90_put_att(ncid,varid,"description","Air temperature at 2 m above ground")) 

    call check(nf90_def_var(ncid, "Td_air", nf90_double, (/t_dimid,f_dimid/),varid))
    call check(nf90_put_att(ncid,varid, "units", "Celsius"))
    call check(nf90_put_att(ncid,varid,"description","Dew point temperature at 2 m above ground, calc. from relative humidity (RH).")) 

    call check(nf90_def_var(ncid, "T_freeze_mod", nf90_double, (/t_dimid,f_dimid/),varid))
    call check(nf90_put_att(ncid,varid, "units", "Celsius"))
    call check(nf90_put_att(ncid,varid,"description","Freezing point temperature"))

    call check(nf90_def_var(ncid, "T_sub_mod", nf90_double, (/t_dimid,f_dimid/),varid))
    call check(nf90_put_att(ncid,varid, "units", "Celsius"))
    call check(nf90_put_att(ncid,varid,"description","Modeled subsurface temperature"))

    call check(nf90_def_var(ncid, "RH_air", nf90_double, (/t_dimid,f_dimid/),varid))
    ...
    call check(nf90_def_var(ncid, "Rain", nf90_double, (/t_dimid,f_dimid/),varid))
    ...
    call check(nf90_def_var(ncid, "Snow", nf90_double, (/t_dimid,f_dimid/),varid))
    call check(nf90_put_att(ncid,varid, "units", "mm"))
    call check(nf90_put_att(ncid,varid,"description","Amount of solid precipitation within the model time step (water equivalent)"))

    call check(nf90_def_var(ncid, "Wind_FF", nf90_double, (/t_dimid,f_dimid/),varid)) !TODO: Rename to Wind_speed?
    ...
    call check(nf90_def_var(ncid, "Wind_DD", nf90_double, (/t_dimid,f_dimid/),varid)) !TODO: Rename to Wind_direction?
    ...
    call check(nf90_def_var(ncid, "SW_rad_cls", nf90_double, (/t_dimid,f_dimid/),varid)) 
    ...
    call check(nf90_def_var(ncid, "Salt1_a", nf90_double, (/t_dimid,f_dimid/),varid)) !NOTE: Give this a more descriptive name? Salting instead of salt?
    ...
    call check(nf90_def_var(ncid, "Salt2_a", nf90_double, (/t_dimid,f_dimid/),varid)) !NOTE: Give this a more descriptive name?
    call check(nf90_put_att(ncid,varid, "units", "g/m2"))
    ...
    call check(nf90_def_var(ncid, "Sand_a", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/m2"))
    call check(nf90_put_att(ncid,varid,"description","Total mass of sand applied in the time step"))

    call check(nf90_def_var(ncid, "Wetting_a", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "mm")) 
    call check(nf90_put_att(ncid,varid,"description","Water added to the road during cleaning or salting "))

    call check(nf90_def_var(ncid, "Ploughing_a", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "1"))
    call check(nf90_put_att(ncid,varid,"description","Snow ploughing event in time step (0 to 1)"))

    call check(nf90_def_var(ncid, "Cleaning_a", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "1")) 
    ...
    call check(nf90_def_var(ncid, "PM10_Emissions_tot", nf90_double, (/t_dimid,f_dimid/),varid)) 
    ...
    call check(nf90_def_var(ncid, "PM25_Emissions_tot", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) !NOTE: doublecheck units
    call check(nf90_put_att(ncid,varid,"description","Total non-exhaust emissions of PM2.5")) 

    call check(nf90_def_var(ncid, "PM10_Emissions_roadwear", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) !NOTE: doublecheck units
    call check(nf90_put_att(ncid,varid,"description","Emissions of PM10 from roadwear")) 

    call check(nf90_def_var(ncid, "PM10_Emissions_tyrewear", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) !NOTE: doublecheck units
    call check(nf90_put_att(ncid,varid,"description","Emissions of PM10 from tyrewear")) 

    call check(nf90_def_var(ncid, "PM10_Emissions_breakwear", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) !NOTE: doublecheck units
    call check(nf90_put_att(ncid,varid,"description","Emissions of PM10 from breakwear")) 

    call check(nf90_def_var(ncid, "PM10_Emissions_sand", nf90_double, (/t_dimid,f_dimid/),varid)) 
    ...
    call check(nf90_def_var(ncid, "PM10_Emissions_fugitive", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
    call check(nf90_put_att(ncid,varid,"description","Fugitive emissions of PM10"))

    call check(nf90_def_var(ncid, "PM10_Emissions_exhaust", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
    call check(nf90_put_att(ncid,varid,"description","Emissions of PM10 from exhaust"))

    call check(nf90_def_var(ncid, "PM10_Emissions_salt1", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
    call check(nf90_put_att(ncid,varid,"description","Emissions of PM10 from NaCl"))

    call check(nf90_def_var(ncid, "PM10_Emissions_salt2", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
    call check(nf90_put_att(ncid,varid,"description","Emissions of PM10 from alternative salt"))

    call check(nf90_def_var(ncid, "PM10_Emissions_direct", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
    call check(nf90_put_att(ncid,varid,"description","Direct emissions of PM10"))

    call check(nf90_def_var(ncid, "PM10_Emissions_suspension", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
    call check(nf90_put_att(ncid,varid,"description","suspension emissions of PM10"))

    call check(nf90_def_var(ncid, "PM10_Emissions_windblown", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
    call check(nf90_put_att(ncid,varid,"description","windblown emissions of PM10"))

    call check(nf90_def_var(ncid, "Mass_dust_PM200", nf90_double, (/t_dimid,f_dimid/),varid)) 
    ...
    call check(nf90_def_var(ncid, "Mass_sand_PM200", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/m2")) !TODO: Check units and description
    call check(nf90_put_att(ncid,varid,"description","Mass of non-suspendable sand (>200 micrometer) on road"))

    call check(nf90_def_var(ncid, "Mass_salt1", nf90_double, (/t_dimid,f_dimid/),varid)) 
    ...
    call check(nf90_def_var(ncid, "Mass_salt2", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/m2")) !TODO: Check units
    call check(nf90_put_att(ncid,varid,"description","Mass of alternative salt on road"))

    call check(nf90_def_var(ncid, "Traffic", nf90_double, (/t_dimid,f_dimid/),varid)) 
    ...
    call check(nf90_def_var(ncid, "HDV", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "%")) 
    call check(nf90_put_att(ncid,varid,"description","Percentage of heavy duty vehicles")) 

    call check(nf90_def_var(ncid, "Studs_li", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "%")) 
    call check(nf90_put_att(ncid,varid,"description","Percentage of light vehicles with studded tyres")) 

    call check(nf90_def_var(ncid, "Studs_he", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "%")) 
    call check(nf90_put_att(ncid,varid,"description","Percentage of heavy vehicles with studded tyres"))

    call check(nf90_def_var(ncid, "Speed_li", nf90_double, (/t_dimid,f_dimid/),varid)) 
    ...
    call check(nf90_def_var(ncid, "NOX_Emissions_tot", nf90_double, (/t_dimid,f_dimid/),varid)) 
    call check(nf90_put_att(ncid,varid, "units", "g/km/h")) 
...
subroutine NORTRIP_save_road_summary_data_netcdf
    ...
    if (save_road_data_flag(ro).ne.0) then !TODO: why is the flag a function of ro?
        ...
        do ti=min_time_save,max_time_save   
            ...
            call check(nf90_put_var(ncid, varid, sum(E_road_data(total_dust_index,pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))
    
            call check(nf90_inq_varid(ncid, "PM25_Emissions_tot",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(total_dust_index,pm_25,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))
    
            call check(nf90_inq_varid(ncid, "PM10_Emissions_roadwear",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(road_index,pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))
    
            call check(nf90_inq_varid(ncid, "PM10_Emissions_tyrewear",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(tyre_index,pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))
    
            call check(nf90_inq_varid(ncid, "PM10_Emissions_breakwear",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(brake_index,pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_sand",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(sand_index,pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_fugitive",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(fugitive_index,pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_exhaust",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(exhaust_index,pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_salt1",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(salt_index(1),pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_salt2",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(salt_index(2),pm_10,E_total_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_direct",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(total_dust_index,pm_10,E_direct_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_suspension",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(total_dust_index,pm_10,E_suspension_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "PM10_Emissions_windblown",varid))
            call check(nf90_put_var(ncid, varid, sum(E_road_data(total_dust_index,pm_10,E_windblown_index,ti,:,ro)), start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "Mass_dust_PM200",varid))
            call check(nf90_put_var(ncid, varid, sum(M_road_data(total_dust_index,pm_200,ti,:,ro))*conversion, start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "Mass_sand_PM200",varid))
            call check(nf90_put_var(ncid, varid, sum(M_road_data(sand_index,pm_200,ti,:,ro))*conversion, start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "Mass_salt1",varid))
            call check(nf90_put_var(ncid, varid, sum(M_road_data(salt_index(1),pm_all,ti,:,ro))*conversion, start = (/ti,ro_tot/)))

            call check(nf90_inq_varid(ncid, "Mass_salt2",varid))
            call check(nf90_put_var(ncid, varid, sum(M_road_data(salt_index(2),pm_all,ti,:,ro))*conversion, start = (/ti,ro_tot/)))
        enddo
        ...
        call check(nf90_put_var(ncid, varid, road_ID(ro_tot), start = (/ro_tot/)))

        call check  (nf90_inq_varid(ncid, "T_surf_mod",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(T_s_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Td_air",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(T_dewpoint_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "T_air",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(T_a_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "T_freeze_mod",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(T_melt_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "T_sub_mod",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(T_sub_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "T_surf_meteo",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(road_temperature_obs_index,:,tr,0), start = (/1,ro_tot/)))
        
        call check(nf90_inq_varid(ncid, "RH_air",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(RH_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Rain",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(Rain_precip_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Snow",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(Snow_precip_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Wind_FF",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(FF_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Wind_DD",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(DD_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "SW_rad_cls",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(short_rad_in_clearsky_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "SW_rad_in",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(short_rad_in_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "LW_rad_in",varid))
        call check(nf90_put_var(ncid, varid, meteo_data(long_rad_in_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "SW_rad_net",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(short_rad_net_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "LW_rad_net",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(long_rad_net_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "H_in",varid))
        call check(nf90_put_var(ncid, varid, -road_meteo_data(H_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "L_in",varid))
        call check(nf90_put_var(ncid, varid, -road_meteo_data(L_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "G_sub",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(G_sub_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "G_net",varid))
        call check(nf90_put_var(ncid, varid, road_meteo_data(G_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "W_surf_mod",varid))
        call check(nf90_put_var(ncid, varid, g_road_data(water_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "I_surf_mod",varid))
        call check(nf90_put_var(ncid, varid, g_road_data(ice_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "S_surf_mod",varid))
        call check(nf90_put_var(ncid, varid, g_road_data(snow_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "f_q",varid))
        call check(nf90_put_var(ncid, varid, f_q(road_index,:,tr,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Salt1_a",varid))
        call check(nf90_put_var(ncid, varid, activity_data(M_salting_index(1),:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Salt2_a",varid))
        call check(nf90_put_var(ncid, varid, activity_data(M_salting_index(2),:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Sand_a",varid))
        call check(nf90_put_var(ncid, varid, activity_data(M_sanding_index,:,0)*f_PM_bin(sand_index,pm_all,1), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Wetting_a",varid))
        call check(nf90_put_var(ncid, varid, activity_data(g_road_wetting_index,:,0), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Ploughing_a",varid))
        call check(nf90_put_var(ncid, varid, activity_data(t_ploughing_index,:,0)*h_ploughing_moisture(snow_index), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Cleaning_a",varid))
        call check(nf90_put_var(ncid, varid, activity_data(t_cleaning_index,:,0)*efficiency_of_cleaning(ro_tot), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Traffic",varid))
        call check(nf90_put_var(ncid, varid, traffic_data(N_total_index,:,ro), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "HDV",varid))
        call check(nf90_put_var(ncid, varid, fr_hdv, start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Studs_li",varid))
        call check(nf90_put_var(ncid, varid, st_li, start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Studs_he",varid))
        call check(nf90_put_var(ncid, varid, st_he, start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "Speed_li",varid))
        call check(nf90_put_var(ncid, varid, traffic_data(V_li_index,:,ro), start = (/1,ro_tot/)))

        call check(nf90_inq_varid(ncid, "NOX_Emissions_tot",varid))
        call check(nf90_put_var(ncid, varid, airquality_data(NOX_emis_index,:,ro), start = (/1,ro_tot/)))
